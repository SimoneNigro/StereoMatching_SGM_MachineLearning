...
int main( int argc, char** argv )
{
    ...
    std::ifstream input("/home/simo/Dropbox/TESI/PREVEDI 01/risultanti/mediaDifferenze");
    string line;
    float quattro = 0;
    float tre = 0;
    float due = 0;
...
printf("Media differenze 4: %f Media differenze 3: %f Media differenze 2: %f Media differenze 1: %f Media differenze 0: %f\n", media4, media3, media2, media1, media0);
...
printf("Soglia 4 ----> Differnza MAX: %f\tDiffernza MIN: %f\tImmagineMax: %d ImmagineMin: %d\n", max4, min4, indice_max4, indice_min4);
printf("Soglia 3 ----> Differnza MAX: %f\tDiffernza MIN: %f\tImmagineMax: %d ImmagineMin: %d\n", max3, min3, indice_max3, indice_min3);
printf("Soglia 2 ----> Differnza MAX: %f\tDiffernza MIN: %f\tImmagineMax: %d ImmagineMin: %d\n", max2, min2, indice_max2, indice_min2);
printf("Soglia 1 ----> Differnza MAX: %f\tDiffernza MIN: %f\tImmagineMax: %d ImmagineMin: %d\n", max1, min1, indice_max1, indice_min1);
printf("Soglia 0 ----> Differnza MAX: %f\tDiffernza MIN: %f\tImmagineMax: %d ImmagineMin: %d\n", max0, min0, indice_max0, indice_min0);
